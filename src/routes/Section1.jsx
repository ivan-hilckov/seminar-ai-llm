...
import { slides, partOf, parts } from '../slides/section-1/index.js';
import './Section1.css';
...
const PART_ORDER = ['I', 'II', 'III', 'closing'];

export default function Section1() {
  const byPart = { I: [], II: [], III: [], closing: [] };
...
function Part({ info, slides: list, marker }) {
  ...
  const markerLabel = marker === 'closing' ? '·' : marker;
  return (
