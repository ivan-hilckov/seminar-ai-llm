...
export const slides = [
  ...
  ready('30', 'B', 'Модель не помнит — перечитывает', '2.2 Контекст и память', Slide30),
  ready('31', 'C', 'Контекстное окно', '2.2 Контекст и память', Slide31),

  // 2.3 Как рождается ответ
  ready('32', 'C', 'Как выбирается слово', '2.3 Как рождается ответ', Slide32),
  ready('33', 'D', 'Тот же вопрос — разный ответ', '2.3 Как рождается ответ', Slide33),

  // 2.4 Обучение и заморозка
  ready('34', 'C', 'Как училась модель', '2.4 Обучение и заморозка', Slide34),
  ready('35', 'C', 'После обучения карта застывает', '2.4 Обучение и заморозка', Slide35),
