...
export const slides = [
  ...
  ready('51', 'E', 'Доверяй — но проверяй', '3.4 Точность и галлюцинации', Slide51),
  ready('52', 'D', 'Где проверять обязательно', '3.4 Точность и галлюцинации', Slide52),

  // 3.5 Границы применения (53–54)
  ready('53', 'B', 'AI берёт на себя задачи, не роль', '3.5 Границы применения', Slide53),
