...
/**
 * Реестр всех слайдов Секции 1 (02–43 · 42 слайда · 90 мин).
 * Сквозная нумерация без пропусков; E-моменты (кроме keystone 28) убраны.
...
export const slides = [
  ...
  // 1.4 ChatGPT 2022
  ready('15', 'C', 'ChatGPT, 30 ноября 2022', '1.4 ChatGPT 2022', Slide15),
  ready('16', 'C', 'RLHF · обучение с обратной связью от человека', '1.4 ChatGPT 2022', Slide16),
  ready('17', 'C', 'За сколько сервисы добирались до 100 миллионов', '1.4 ChatGPT 2022', Slide17),

  // 1.5 Думающие модели
  ready('18', 'B', '2024–2025: модели, которые думают', '1.5 Думающие модели', Slide18),
  ready('19', 'C', 'Chain of Thought', '1.5 Думающие модели', Slide19),
  ready('20', 'D', 'Обычная модель vs думающая', '1.5 Думающие модели', Slide20),
  ready('21', 'D', 'Что меняется', '1.5 Думающие модели', Slide21),
  ready('22', 'D', 'У думающих моделей выше галлюцинации', '1.5 Думающие модели', Slide22),

  // 1.6 Главный вывод
  ready('23', 'C', 'От слова к рассуждению', '1.6 Главный вывод', Slide23),
  ready('24', 'E', 'Это не интеллект. Это статистика.', '1.6 Главный вывод', Slide24, { keystone: true }),

  // 2.0 Заставка
  ready('25', 'A', 'Как это работает внутри', '2.0 Заставка', Slide25),

  // 2.1 Векторы смыслов
  ready('26', 'B', 'Откуда модель знает, что «врач» и «доктор» близки?', '2.1 Векторы смыслов', Slide26),
  ready('27', 'C', 'Пространство смыслов', '2.1 Векторы смыслов', Slide27),
  ready('28', 'B', 'Близость = смысл', '2.1 Векторы смыслов', Slide28),
  ...
  ready('40', 'D', 'Где проверять обязательно', '3.4 Точность и галлюцинации', Slide40),

  // 3.5 Границы применения
  ready('41', 'B', 'AI берёт на себя задачи, не роль', '3.5 Границы применения', Slide41),
  ready('42', 'B', 'Она понимает буквально — не интуитивно', '3.5 Границы применения', Slide42),

  // Итог первой половины (три колонки по главам + таймлайн истории LLM)
  ready('43', 'C', 'Что мы прошли', 'Итог', Slide43),
];
 ...
 * Итоговый слайд «Что мы прошли» (43) входит в Часть III.
 */
