...
/**
 * Реестр всех слайдов Секции 1 (02–45 · 44 слайда · 90 мин).
...
export const slides = [
  ...
  ready('37', 'D', 'Новый чат — новый лист', '3.1 Память и контекст в работе', Slide37),
  ready('38', 'C', 'Память (Memory) — отдельная функция', '3.1 Память и контекст в работе', Slide38),

  // 3.2 Доступ к интернету
  ready('39', 'C', 'Поиск — отдельная функция', '3.2 Доступ к интернету', Slide39),

  // 3.3 Точность и галлюцинации
  ready('40', 'B', 'Где данных мало — модель достраивает', '3.3 Точность и галлюцинации', Slide40),
  ready('41', 'D', 'Как выглядит галлюцинация', '3.3 Точность и галлюцинации', Slide41),
  ready('42', 'C', 'Где отвечает точно, а где выдумывает', '3.3 Точность и галлюцинации', Slide42),
  ready('43', 'D', 'Где проверять обязательно', '3.3 Точность и галлюцинации', Slide43),
  ready('44', 'B', 'Модель чаще соглашается, чем возражает', '3.3 Точность и галлюцинации', Slide44),

  // Итог первой половины (три колонки по главам + таймлайн истории LLM)
  ready('45', 'C', 'Что мы прошли', 'Итог', Slide45),
];
